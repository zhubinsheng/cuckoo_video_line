package com.eliaovideo.videoline.webview.config;
...
public class CuckooWebViewClient extends WebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        ...
        if (url.contains("invite_share")) {
            ...
            shareDialog.setShareUrl(ConfigModel.getInitData().getShare_url_domain() + "/mapi/public/index.php/api/download_api/index?invite_code=" + SaveData.getInstance().getId());
            shareDialog.show();
            return true;
        }
