 ...
 */
public class TiWatermarkAdapter extends RecyclerView.Adapter<TiWatermarkViewHolder> {
    ...
    @NonNull
    @Override
    public TiWatermarkViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ti_watermark, parent, false);
        return new TiWatermarkViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final TiWatermarkViewHolder holder, int position) {
        ...
        if (tiWatermark == TiWatermark.NO_WATERMARK) {
            holder.thumbIV.setImageResource(R.drawable.ic_ti_none_unselected);
        } else {
